...
func TestSignalInfoCoversAll(t *testing.T) {
	...
	if all != SignalRequestGap|SignalLowExecution|SignalLargeUnused|SignalCut|SignalExecutionWithoutBudget|SignalNegativeUnused|SignalOutcomeShortfall|SignalOutcomeOvershoot|SignalNoOutcomeActual|SignalReflectionContradicted|SignalRequestZeroed|SignalAmountRevised {
